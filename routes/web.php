...
//guru
// Route::get('/guru', [App\Http\Controllers\TuController::class, 'index'])->name('gurus');
// Route::post('/guru/store', [App\Http\Controllers\TuController::class, 'store'])->name('guru-store');
// Route::get('/guru/all', [App\Http\Controllers\TuController::class, 'all'])->name('guru-all');
// Route::get('/guru/edit', [App\Http\Controllers\TuController::class, 'edit'])->name('guru-edit');
// Route::post('/guru/update', [App\Http\Controllers\TuController::class, 'update'])->name('guru-update');
// Route::delete('/guru/delete', [App\Http\Controllers\TuController::class, 'delete'])->name('guru-delete');
